...
def command_clean(
    ...
    print(f"[OK] 清理完成，删除 {removed} 个文件")
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description=("Universal Clash Rule Compiler"))
